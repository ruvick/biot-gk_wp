  ...
  <div class="container">
    ...
    <div class="structure-wrapper">
      <div class="structure-item">
        <a href="<?php echo get_permalink(38);?>"  class="structure-item__photo" style="background-image: url(<?php echo get_template_directory_uri();?>/img/str-1.png)"></a>
      ...
      <div class="structure-item">
        <a href="<?php echo get_permalink(40);?>"  class="structure-item__photo" style="background-image: url(<?php echo get_template_directory_uri();?>/img/str-2.png)"></a>
        <div class="structure-item__content">
      ...
      <div class="structure-item">
        <a href="<?php echo get_permalink(42);?>" class="structure-item__photo" style="background-image: url(<?php echo get_template_directory_uri();?>/img/str-3.png)"></a>
        <div class="structure-item__content">
      ...
      <div class="structure-item">
        <a href="http://xn--46-6kcpaebi3eiv6d.xn--p1ai/"  class="structure-item__photo" style="background-image: url(<?php echo get_template_directory_uri();?>/img/str-4.png)"></a>
        <div class="structure-item__content">
